...
enum timed_effects
{ 
	TMD_BLIND = 0, TMD_PARALYZED, TMD_IMAGE, 
	TMD_POISONED, TMD_CUT, TMD_PROTEVIL, TMD_INVULN, TMD_HERO, 
	TMD_SHERO, TMD_SHIELD, TMD_BLESSED, TMD_SINVIS, TMD_SINFRA,
	TMD_OPP_POIS, TMD_OPP_ACID, TMD_OPP_ELEC, TMD_OPP_FIRE, TMD_OPP_COLD
}; 

#define TMD_MAX (TMD_OPP_COLD+1)

ZAIBAND_STATIC_ASSERT(0<=TMD_BLIND && TMD_MAX>TMD_BLIND);
ZAIBAND_STATIC_ASSERT(0<=TMD_PARALYZED && TMD_MAX>TMD_PARALYZED);
ZAIBAND_STATIC_ASSERT(0<=TMD_IMAGE && TMD_MAX>TMD_IMAGE);
ZAIBAND_STATIC_ASSERT(0<=TMD_POISONED && TMD_MAX>TMD_POISONED);
ZAIBAND_STATIC_ASSERT(0<=TMD_CUT && TMD_MAX>TMD_CUT);
ZAIBAND_STATIC_ASSERT(0<=TMD_PROTEVIL && TMD_MAX>TMD_PROTEVIL);
ZAIBAND_STATIC_ASSERT(0<=TMD_INVULN && TMD_MAX>TMD_INVULN);
ZAIBAND_STATIC_ASSERT(0<=TMD_HERO && TMD_MAX>TMD_HERO);
ZAIBAND_STATIC_ASSERT(0<=TMD_SHERO && TMD_MAX>TMD_SHERO);
ZAIBAND_STATIC_ASSERT(0<=TMD_SHIELD && TMD_MAX>TMD_SHIELD);
ZAIBAND_STATIC_ASSERT(0<=TMD_BLESSED && TMD_MAX>TMD_BLESSED);
ZAIBAND_STATIC_ASSERT(0<=TMD_SINVIS && TMD_MAX>TMD_SINVIS);
ZAIBAND_STATIC_ASSERT(0<=TMD_SINFRA && TMD_MAX>TMD_SINFRA);
ZAIBAND_STATIC_ASSERT(0<=TMD_OPP_POIS && TMD_MAX>TMD_OPP_POIS);
ZAIBAND_STATIC_ASSERT(0<=TMD_OPP_ACID && TMD_MAX>TMD_OPP_ACID);
ZAIBAND_STATIC_ASSERT(0<=TMD_OPP_ELEC && TMD_MAX>TMD_OPP_ELEC);
ZAIBAND_STATIC_ASSERT(0<=TMD_OPP_FIRE && TMD_MAX>TMD_OPP_FIRE);
ZAIBAND_STATIC_ASSERT(0<=TMD_OPP_COLD && TMD_MAX>TMD_OPP_COLD);

enum core_timed_effects
{
	CORE_TMD_FAST = 0,
	CORE_TMD_SLOW,
	CORE_TMD_CONFUSED,
...
#define CORE_TMD_MAX (CORE_TMD_STUN+1)

ZAIBAND_STATIC_ASSERT(0<=CORE_TMD_FAST && CORE_TMD_MAX>CORE_TMD_FAST);
ZAIBAND_STATIC_ASSERT(0<=CORE_TMD_SLOW && CORE_TMD_MAX>CORE_TMD_SLOW);
ZAIBAND_STATIC_ASSERT(0<=CORE_TMD_CONFUSED && CORE_TMD_MAX>CORE_TMD_CONFUSED);
ZAIBAND_STATIC_ASSERT(0<=CORE_TMD_AFRAID && CORE_TMD_MAX>CORE_TMD_AFRAID);
ZAIBAND_STATIC_ASSERT(0<=CORE_TMD_STUN && CORE_TMD_MAX>CORE_TMD_STUN);
