...
enum timed_effects
{ 
	TMD_FAST = 0, TMD_SLOW, TMD_BLIND, TMD_PARALYZED, TMD_IMAGE, 
	TMD_POISONED, TMD_CUT, TMD_STUN, TMD_PROTEVIL, TMD_INVULN, TMD_HERO, 
...
ZAIBAND_STATIC_ASSERT(0<=TMD_FAST && TMD_MAX>TMD_FAST);
ZAIBAND_STATIC_ASSERT(0<=TMD_SLOW && TMD_MAX>TMD_SLOW);
...
ZAIBAND_STATIC_ASSERT(0<=TMD_STUN && TMD_MAX>TMD_STUN);
...
#define CORE_TMD_MAX (CORE_TMD_AFRAID+1)
