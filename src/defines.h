...
enum timed_effects
{ 
	TMD_FAST = 0, TMD_SLOW, TMD_BLIND, TMD_PARALYZED, TMD_AFRAID,
	TMD_IMAGE, TMD_POISONED, TMD_CUT, TMD_STUN, TMD_PROTEVIL, TMD_INVULN,
	TMD_HERO, TMD_SHERO, TMD_SHIELD, TMD_BLESSED, TMD_SINVIS, TMD_SINFRA,
...
ZAIBAND_STATIC_ASSERT(0<=TMD_AFRAID && TMD_MAX>TMD_AFRAID);
...
#define CORE_TMD_MAX (CORE_TMD_CONFUSED+1)
