...
#define OPT_birth_dungeon_align		(OPT_BIRTH+9)
#define OPT_birth_dungeon_stair		(OPT_BIRTH+10)
#define OPT_birth_flow_by_sound		(OPT_BIRTH+11)
#define OPT_birth_flow_by_smell		(OPT_BIRTH+12)
#define OPT_birth_smart_monsters	(OPT_BIRTH+13)
#define OPT_birth_smart_packs		(OPT_BIRTH+14)
#define OPT_birth_smart_learn		(OPT_BIRTH+15)
#define OPT_birth_smart_cheat		(OPT_BIRTH+16)
#define OPT_birth_know				(OPT_BIRTH+17)
...
#define OPT_adult_dungeon_align		(OPT_ADULT+9)
#define OPT_adult_dungeon_stair		(OPT_ADULT+10)
#define OPT_adult_flow_by_sound		(OPT_ADULT+11)
#define OPT_adult_flow_by_smell		(OPT_ADULT+12)
#define OPT_adult_smart_monsters	(OPT_ADULT+13)
#define OPT_adult_smart_packs		(OPT_ADULT+14)
#define OPT_adult_smart_learn		(OPT_ADULT+15)
#define OPT_adult_smart_cheat		(OPT_ADULT+16)
#define OPT_adult_know				(OPT_ADULT+17)
/* xxx xxx */
