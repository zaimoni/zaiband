...
extern bool place_monster(coord g, bool slp, bool grp, s16b m_level);
...
extern bool make_object(object_type *j_ptr, bool good, bool great, s16b o_level);
extern s16b floor_carry(int y, int x, object_type *j_ptr);
extern void drop_near(object_type *j_ptr, int chance, coord t);
extern void acquirement(coord t, int num, bool great, s16b o_level);
extern void place_object(int y, int x, bool good, bool great, s16b o_level);
extern void place_gold(int y, int x, s16b o_level);
...
extern void message(u16b message_type, const char* message);
extern void message_format(u16b message_type, const char* fmt, ...);
