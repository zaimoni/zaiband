...
public:	
	...
	void be_aware(const object_type& o) {assert(0<o.k_idx && z_info->k_max>o.k_idx); object_awareness[o.k_idx] |= PY_OBJECT_AWARE;};
	void be_aware(s16b k_idx) {assert(0<k_idx && z_info->k_max>k_idx); object_awareness[k_idx] |= PY_OBJECT_AWARE;};
	void have_tried(const object_type& o) const {assert(0<o.k_idx && z_info->k_max>o.k_idx); object_awareness[o.k_idx] |= PY_OBJECT_TRIED;};
